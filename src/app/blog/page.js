...
export default function BlogPage() {
  ...
  return (
    <div className="pt-20 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Config tip */}
      <div className="mt-12 card p-5 border-purple-500/20 bg-purple-500/5">
        <p className="text-purple-300 text-sm font-medium mb-1">📌 Configure Your Medium Blog</p>
        <p className="text-slate-500 text-xs">
          Set <code className="text-cyan-400 bg-neural-700 px-1 rounded">MEDIUM_USERNAME=your_username</code> in your{' '}
          <code className="text-cyan-400 bg-neural-700 px-1 rounded">.env.local</code> file to display your own Medium posts.
        </p>
      </div>
    </div>
  );
